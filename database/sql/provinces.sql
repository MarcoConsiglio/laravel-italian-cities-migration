...
CREATE TABLE `provinces` (
  ...
  `metropolitan_city_code` int(11) unsigned DEFAULT NULL,
  `name` text NOT NULL,
  `automotive_abbreviation` varchar(2) NOT NULL,
